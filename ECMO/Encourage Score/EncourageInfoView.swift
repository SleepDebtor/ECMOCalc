			...
			if orientation.isLandscape {
					...
					ZStack {
						...
						Rectangle()
							...
							Image(ImageResource.ecourageGraph)
							.resizable()
							.scaledToFit()
					}
				}
...
//
						...
						.padding(.bottom)
						Link(destination: URL(string: "https://doi.org/10.1007/s00134-016-4223-9")!) {
							Text(EncourageScore.citationStr)
								.font(.caption)
								.italic()
								.foregroundStyle(.blue)
						}
						Spacer()
						Text(EncourageScore.purposeStr)
							.font(.caption)
